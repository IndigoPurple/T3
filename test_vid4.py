...
data_list = ['calendar', 'city', 'foliage', 'walk']

# log_location = './save/vid4_iter/out_file.out'
...
for data in data_list:
   print('---------------',data)
   opt.input = './input/vid4/'+ data +'/gray.mp4'
   opt.reference_dir = './input/vid4/' + data +'/references/'

   print('Processing %s...'%os.path.basename(opt.input))

   outputdir = './save/vid4_iter/%s/'%data
